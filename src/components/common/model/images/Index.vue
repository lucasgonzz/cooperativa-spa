<template>
	<div
	class="images m-b-15"
	v-if="model.id && (has_image || has_images)">
...
export default {
	...
	computed: {
		url() {
			return process.env.VUE_APP_API_URL+'/api/set-image'
		},
		params() {
			return {
		...
		has_image() {
			return typeof this.model.image_url != 'undefined'
		},
		has_images() {
			return typeof this.model.images != 'undefined'
		},
	},
	methods: {
		uploadImage() {
